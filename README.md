...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-modeltools-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-modeltools-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-modeltools-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-modeltools-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-modeltools-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-modeltools-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-modeltools/badges/version.svg)](https://anaconda.org/conda-forge/r-modeltools)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-modeltools/badges/downloads.svg)](https://anaconda.org/conda-forge/r-modeltools)
